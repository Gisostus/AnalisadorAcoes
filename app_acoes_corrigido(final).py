...
class AnalisadorAcoesReais:
    ...
    def analisar_acao(self):
        ...
        try:
            ...
            # Buscar dados fundamentalistas e calcular Retention Ratio
...
│ 💎 RETENTION RATIO: {retention_ratio if retention_ratio else 'N/A'}%                      │
│ 📊 INTERPRETAÇÃO: {retention_interpretacao}          │
│ 💡 SIGNIFICADO: {'Alta retenção = Foco em crescimento' if retention_ratio and retention_ratio > 60 else 'Baixa retenção = Foco em dividendos' if retention_ratio and retention_ratio < 40 else 'Equilibrio crescimento/dividendos'}│
